...
import RefinementRunDetails from "./RefinementRunDetails"
...
export default function RefinementDetailsBlade({
  ...
  const fullTitle = `ID: ${refinementId} - Refinement details - ${fluxName}`
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="flex flex-col h-full">
              ...
              <TabsContent value="details" className="flex-grow overflow-auto">
                <div className="p-4 md:p-6">
                  <RefinementRunDetails refinementId={refinementId} />
                </div>
              </TabsContent>
            </Tabs>
          </div>
