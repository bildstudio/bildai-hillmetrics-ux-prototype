...
import CalculationRunDetails from "./CalculationRunDetails"
...
export default function CalculationDetailsBlade({
  ...
  const fullTitle = `ID: ${calculationId} - Calculation details - ${fluxName}`
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="flex flex-col h-full">
              ...
              <TabsContent value="details" className="flex-grow overflow-auto">
                <div className="p-4 md:p-6">
                  <CalculationRunDetails calculationId={calculationId} />
                </div>
              </TabsContent>
            </Tabs>
          </div>
